...
namespace MWPhysics
{
    ...
    public:
        ...
        ActorConvexCallback(const JPH::BodyID actor, const JPH::PhysicsSystem* inPhysicsSystem, JPH::RVec3 origin, float minCollisionDot, JPH::Vec3 motion)
            : mMe(actor)
        ...
        bool hasHit() const {
            return mHitCollisionObject != nullptr;
        }
